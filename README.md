...
本ページに掲載するプロジェクトは、AIエージェントツール（Claude Code / Codexなど）を駆使しながら設計・実装した成果物です。
...
> [詳細を見る](https://yuyayoshiok.github.io/resume/projects/my-digital-butler/)
...
> [詳細を見る](https://yuyayoshiok.github.io/resume/projects/kabuself/)
...
> [詳細を見る](https://yuyayoshiok.github.io/resume/projects/ai-audio/)
...
| プロジェクト | 概要 | 技術 |
|---|---|---|
| [x-yuya Radio](https://yuyayoshiok.github.io/resume/projects/x-yuya-radio/) | Codex/AivisSpeechが毎朝ラジオ音声を自動生成 | Codex / AivisSpeech / Cloudflare |
| [Kanban](https://yuyayoshiok.github.io/resume/projects/kanban/) | Google Tasks連携・LLMチャット搭載の自分専用ダッシュボード | React / TypeScript / Cloudflare |
| [youtube-importer](https://yuyayoshiok.github.io/resume/projects/youtube-importer/) | YouTubeを監視し新着を文字起こし→要約→Obsidianへ自動保存 | Python / GitHub Actions / Groq Whisper |
| [x-bookmark-enricher](https://yuyayoshiok.github.io/resume/projects/x-bookmark-enricher/) | XブックマークをAIで要約・タグ付けしObsidian Vaultへインポート | TypeScript / Groq / Playwright |
...
| [VoC分析ツール](https://yuyayoshiok.github.io/resume/projects/voc-analyzer/) | VBA | 月20万件の顧客の声を自動分析・集計するツールを設計・実装 |
