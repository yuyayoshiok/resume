...
吃音があり、口頭コミュニケーションよりもテキストで力を発揮するタイプです。この特性がデータ入力→VBA自動化→AI活用というキャリアの一貫した方向性を生みました。電話対応が苦手な分、正確さとスピードで誰よりも貢献しようとする中で、「この作業、自動化できるのでは？」という視点が芽生え、独学でプログラミングを習得。
