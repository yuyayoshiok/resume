...
| プロジェクト | 概要 | 技術 |
|---|---|---|
| x-yuya | Codex/AivisSpeechが毎朝ラジオ音声を自動生成 | Codex/ AivisSpeech / Cloudflare |
| Kanban | Google Tasks連携・LLMチャット搭載の自分専用ダッシュボード | React / TypeScript / Cloudflare |
...
| VoC分析ツール | VBA | 月20万件の顧客の声を自動分析・集計するツールを設計・実装 |
