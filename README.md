...
- 業務支援チームとして、ChatGPTを使った業務改善のPoCを行った
...
### スキルと強み
1. **業務改善への情熱**
   - 日々の業務の中で改善点を見つけ出し、解決策を考えることが得意です。
   - 「もっと良くできるはず」という思いを大切に、常に改善を心がけています。

2. **現場の経験を活かした提案力**
   - データ入力の現場で培った経験があります。
   - 実際に働く人の悩みや要望を理解できます。
   - 現場の声を大切にした、実践的な改善提案ができます。

3. **円滑なコミュニケーション能力**
   - タイピングが速いので、チャットでの素早い情報共有が得意です。
   - 様々なツールを使いこなし、必要な情報を整理できます。
   - 分かりやすい文章で、確実に意図を伝えることができます。

### キャリアの展望

データ入力業務で経験した非効率な作業プロセスを改善したいという思いから、プログラミングを独学で習得いたしました。

現在は、その経験を活かして業務改善の提案から実装までを一貫して行えるエンジニアとして活動しています。

今後は、AWS等のクラウド技術やLaravelでのWeb開発スキルを強化し、より大規模なシステム開発にも携われる技術者を目指しています。

### キャリアの転換点
元々精神的に弱く、仕事を転々としていました。現在も月1で通院をしています。

今のキャリアを構築できたことで自分自身の大元の「自信がない」という不安が解消され、自信が持てるようになりました。

## 業務効率化の実績（社内システムのため、文章にて失礼します。）
...
- プレビュー画面を表示することで、メールの内容を確認できるようにした
